...
export default function PodProductTable({products,pageInfo}) {
  ...
  const productRows = filteredProducts.map((product) => ({
    ...
    children: [
      ...
      size="extraSmall"
    />,
      product.node.title, // Product Name
      ...
      <Tooltip content="View Product">
        <Button url={"/app/product/pod/"+product.node.id.slice(22)} icon={ViewIcon}></Button>
      </Tooltip>
    ],
  }));
  return (
